...
A typical illustration of a reflection coefficient ($\Gamma$) in show in \figurename~\ref{fig:wec_as_multiport_reflection_coefficient}, where $\Gamma$ is defined as the ratio of the reflected power to the incident power \cite{Kurokawa:1965aa}.
%
\begin{figure}[tb]
        \centering
...
%
\begin{equation}
        \Gamma =\left| \frac{Z_\ell - Z_s^*}{Z_\ell + Z_s} \right|^2
        \label{eq:reflection_coeff_impedances}
\end{equation}
%
Note that the fraction of power transmitted is $1 - \Gamma$.
...
Expanding on \cite{Bacelli:2021aa}, this paper casts the WEC design problem as an impedance shaping problem.
