...
The complex power at the load is half the product of the effort ($Z_\ell I_{\textrm{out}}$) and complex conjugate flow ($I_{\textrm{out}}^*$) at the load \rc{XX-cite}. \dg{XX - this should be Re(Zl)??}
